...
func TestServiceUpdate_NoAuth_Returns500(t *testing.T) {
	r := mux.NewRouter()
	...
	req, err := http.NewRequest(http.MethodPatch, ts.URL+"/api/namespaces/ns/services/svc", bytes.NewBufferString("[]"))
	if err != nil {
		t.Fatal(err)
	}
